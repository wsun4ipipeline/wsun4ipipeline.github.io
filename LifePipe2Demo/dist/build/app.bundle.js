...
(function (EnumPage) {
    ...
    EnumPage[EnumPage["QuoteInputAndSubmit"] = 3] = "QuoteInputAndSubmit";
...
exports.ActionTypes = {
    ...
    StartNewQuote: 'START_NEWQUOTE',
    ResultsReceived: 'RESULTS_RECEIVED',
    UpdateInputData: 'UPDATE_INPUTDATA',
    UpdateFilter: 'UPDATE_FILTER',
    UpdateInputDataAndSubmitQuote: 'UPDATE_INPUTDATA_SUBMIT_QUOTE' //preprae for NGSD page to pass data and run quote
};
//action only wrap the data and with the ActionTypes for reduce to update state data in global store
var submitQuote = function (data) { return ({
    type: exports.ActionTypes.SubmitQuote,
    actionData: data
}); };
exports.submitQuote = submitQuote;
var startNewQuote = function (data) { return ({
    type: exports.ActionTypes.StartNewQuote,
    actionData: data
}); };
exports.startNewQuote = startNewQuote;
//for external module updateInput fields 
var updateInputData = function (data, submitQuote) { return ({
    type: submitQuote ? exports.ActionTypes.SubmitQuote : exports.ActionTypes.UpdateInputData,
    actionData: data
}); };
exports.updateInputData = updateInputData;
var updateFilter = function (data) { return ({
    type: exports.ActionTypes.UpdateFilter,
    actionData: data
}); };
...
var DefaultQuoteInputData = {
    ...
    terms: DefaultFilter.selectedTerms,
    avaliableTerms: AvaliableTerms,
    state: "PA",
...
var UnderwritingInputs_1 = __webpack_require__(51);
...
var FilterSideBar_1 = __webpack_require__(44);
exports.FilterSideBar = FilterSideBar_1.FilterSideBar;
var FilterPopup_1 = __webpack_require__(43);
exports.FilterPopup = FilterPopup_1.FilterPopup;
var QuoteInfoDisplay_1 = __webpack_require__(48);
exports.QuoteInfoDisplay = QuoteInfoDisplay_1.QuoteInfoDisplay;
var QuoteResultsPanel_1 = __webpack_require__(49);
...
var DateUtility = (function () {
    ...
    DateUtility.prototype.getDateString = function (date) {
        if (typeof date === 'string')
            date = new Date(date);
        var re = numberUtility.pad((date.getUTCMonth() + 1), 2) + "/" + numberUtility.pad(date.getUTCDate(), 2) + "/" + date.getUTCFullYear();
        //return "mm/dd/yyyy";
        return re;
    };
    DateUtility.prototype.getDateForJson = function (date) {
        if (typeof (date) === 'string') {
            return date.substr(0, 10);
        }
        var re = date.toISOString().toString().substr(0, 10);
        //return "yyyy-mm-dd";
        return re;
    };
    DateUtility.prototype.DateString2JsonFormat = function (dateStr) {
...
var NumberUtility = (function () {
    ...
    NumberUtility.prototype.pad = function (num, size) {
        var s = num + "";
        while (s.length < size)
            s = "0" + s;
        return s;
...
var FilterMain = (function (_super) {
    __extends(FilterMain, _super);
    function FilterMain(props) {
        var _this = _super.call(this, props) || this;
        _this.state = lodash_1.assign({}, _this.props.filter);
        return _this;
    }
    FilterMain.prototype.updateState = function (newState) {
        console.log("FilterMain.updateState->", newState);
        this.setState(newState);
        this.props.handleFilterUpdate(newState);
    };
    FilterMain.prototype.handleInputChange = function (event) {
        console.log("FilterMain->handleInputChange:", event.target);
        ...
        if (target.htmlFor == 'showError' && target.firstChild) {
            ...
            if (target.name.indexOf("paymentOption-") == 0) {
            ...
            else if (target.name.indexOf("filter-term-") == 0) {
                var terms = lodash_1.assign([], this.state.selectedTerms);
                ...
                var newState = lodash_1.assign({}, this.state, { selectedTerms: terms });
                this.updateState(newState);
            }
        }
    };
    FilterMain.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", null,
            ...
            React.createElement("div", { className: "col-xs-12  noPadding-side" },
                ...
                React.createElement("div", { className: "col-xs-10  noPadding-side" },
                    React.createElement("div", { className: "btn-toolbar", role: "toolbar", "aria-label": "..." }, QuoteInputData_1.AvaliableTerms.map(function (item) {
                        return (React.createElement("div", { className: "btn-group", key: "filter-term-" + item.value },
                            React.createElement("button", { type: "button", name: "filter-term-" + item.value, value: item.value, onClick: _this.handleInputChange.bind(_this), className: "btn btn-primary " + ((_this.state.selectedTerms.indexOf(item.value) > -1) ? 'active' : '') }, item.label)));
                    })))),
            React.createElement("div", { className: "col-xs-12 noPadding-side" },
                React.createElement("div", { className: "col-xs-12 noPadding-side" },
...
var App = (function (_super) {
    ...
    function App(props) {
        var _this = this;
        console.log("constuctor->props:", props);
...
function reducers(state, action) {
    ...
    console.log('reducer->actionItem:', action);
    var newState, inputdata, filterData;
    switch (action.type) {
        case actions_1.ActionTypes.SubmitQuote:
            inputdata = updateAndValidateQuoteInputData(action.actionData);
            // state.filters.selectedTerms = inputdata.terms;
            var mfilters = lodash_1.assign({}, state.filters);
            mfilters.selectedTerms = inputdata.terms;
            newState = lodash_1.assign({}, state, { quoteInputData: inputdata, filters: mfilters });
            newState.currentpage = state_1.EnumPage.Loading;
            break;
        case actions_1.ActionTypes.StartNewQuote:
            newState = lodash_1.assign({}, state);
            newState.currentpage = state_1.EnumPage.QuoteInput;
            location.hash = state_1.EnumPage[state_1.EnumPage.QuoteInput];
            break;
        case actions_1.ActionTypes.ResultsReceived:
            //todo. add new receivedData to store.state
            var recivedData = action.actionData;
            //build groupData use recivedData
            var groupedData = buildGroupResult(recivedData);
            newState = lodash_1.assign({}, state, { groupedResults: groupedData });
            newState.currentpage = state_1.EnumPage.Results;
            location.hash = state_1.EnumPage[state_1.EnumPage.Results];
            break;
        case actions_1.ActionTypes.UpdateInputData:
            console.log("reducer->updateInputData");
            inputdata = updateAndValidateQuoteInputData(action.actionData);
            newState = lodash_1.assign({}, state, { quoteInputData: inputdata });
            newState.currentpage = state_1.EnumPage.QuoteInput;
            location.hash = state_1.EnumPage[state_1.EnumPage.QuoteInput];
            break;
        case actions_1.ActionTypes.UpdateInputDataAndSubmitQuote:
            console.log("reducer->updateInputDataAndSubmitQuote");
            inputdata = updateAndValidateQuoteInputData(action.actionData);
            newState = lodash_1.assign({}, state, { quoteInputData: inputdata });
            newState.currentpage = state_1.EnumPage.QuoteInputAndSubmit;
            break;
        case actions_1.ActionTypes.UpdateFilter:
            console.log("reducer->UpdateFilter");
            filterData = action.actionData;
            inputdata = state.quoteInputData; //? need assign for new instance?
            inputdata.terms = filterData.selectedTerms;
            newState = lodash_1.assign({}, state, { quoteInputData: inputdata, filters: filterData });
            break;
        default:
            newState = state;
            break;
    }
    console.log('reducer->currentpage', newState.currentpage);
    newState.timestamp = Date.now().toString();
    system_1.Storage["state"] = JSON.stringify(newState); // save current to state to storage for page reload
    return newState;
}
exports.reducers = reducers;
function updateAndValidateQuoteInputData(inputdata) {
    //update birthday and age
    if (inputdata.dateOfBirth) {
        var today = (new Date());
        var dob = new Date(inputdata.dateOfBirth);
        inputdata.age = today.getFullYear() - dob.getFullYear();
        if (today.getMonth() < dob.getMonth()
            || ((today.getMonth() == dob.getMonth()) && (today.getDate() < dob.getDate()))) {
            inputdata.age = inputdata.age - 1;
        }
    }
    console.log("updateAndValidateQuoteInputData", inputdata.age);
    return inputdata;
}
function buildGroupResult(receivedResults) {
    var groupResults = {};
    receivedResults.result.map(function (resultItem) {
        var groupKey = "groupkey-" + resultItem.input.term + "-" + resultItem.input.faceAmount;
        var termItem = QuoteInputData_1.AvaliableTerms.filter(function (x) { return x.value.toString() == resultItem.input.term.toString(); })[0];
        var groupName = (termItem.value < 99 ? (resultItem.input.term + "yr") : "UL") + " - $" + resultItem.input.faceAmount;
        var gruopItems = {
            groupKey: groupKey,
            groupName: groupName,
            groupTerm: termItem.value,
            groupDataItems: []
        };
        if (!groupResults[groupKey]) {
            groupResults[groupKey] = gruopItems;
        }
        groupResults[groupKey].groupDataItems.push(resultItem);
    });
    return groupResults;
}
...
var dataService = function (store) { return function (next) { return function (actionItem) {
    ...
    next(actionItem);
    //ajax call in this meddleware
    switch (actionItem.type) {
        case actions_1.ActionTypes.SubmitQuote:
            console.log("dataService->actionIem:", actionItem);
            if (navigator.onLine) {
                //todo: completed the ajax call here          
                //let inputStr = JSON.stringify({
                //    "inputs": [
                //        {
                //            "companyId": "93",
                //            "productId": "4",
                //            "faceAmounts": "400000,500000",
                //            "terms": "10,20",
                ...
                //    ]
                //});
                var actionData = actionItem.actionData;
                ...
                data.terms = actionData.avaliableTerms.map(function (item) { return item.value; }).toString();
                ...
                var inputStr = JSON.stringify(inputsData);
                // let url = "http://localhost:62735/api/LifePipeApiDemo";
                var url = "https://mobile-qa.ipipeline.com/lifepipeapiDemo/api/LifePipeApiDemo";
                axios_1.default.post(url, {
                    ...
                    var dataReceivedAction = { type: actions_1.ActionTypes.ResultsReceived, actionData: reData };
                    console.log("DataService->next->dataReceivedAction:", reData);
                    next(dataReceivedAction); //call reducers 
                })
                ...
                //mock
                console.log("dataService use mock data for demo offlice");
                var dataReceivedAction = { type: actions_1.ActionTypes.ResultsReceived, actionData: MockQuoteReceivedData_1.mockQuoteReceivedDatas };
...
var React = __webpack_require__(0);
;
var StatesPicker = (function (_super) {
    __extends(StatesPicker, _super);
    function StatesPicker(props) {
        var _this = _super.call(this, props) || this;
        _this.state = {
    ...
    StatesPicker.prototype.handleInputChange = function (event) {
        var value = this.state.selectedValue;
        if (event && event.target && event.target.value !== undefined) {
            event.stopPropagation();
            value = event.target.value;
        }
        console.log("StatesPicker->handleInputChange:", value);
        var newState = { selectedValue: value };
        this.setState(newState);
        this.props.handleStateLocationChange(value);
    };
    StatesPicker.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement("select", { className: "form-control", name: "state", value: this.state.selectedValue, onChange: this.handleInputChange.bind(this) },
                ...
                React.createElement("option", { value: "PR" }, "Puerto Rico"),
...
exports.StatesPicker = StatesPicker;
...
//can move to stype
var btWidth = { width: "100px" };
var ClientInfoInputs = (function (_super) {
    __extends(ClientInfoInputs, _super);
    function ClientInfoInputs(props) {
        var _this = _super.call(this, props) || this;
        //let inputData = props.quoteInputData;
        //let dob = dateUtility.getDateString(inputData.dateOfBirth);
        //this.state = assign({dob:dob},inputData);
        _this.initData(props);
        return _this;
    }
    ClientInfoInputs.prototype.initData = function (props) {
        var inputData = props.quoteInputData;
        var dob = utilities_1.dateUtility.getDateString(inputData.dateOfBirth);
        this.state = lodash_1.assign({ dob: dob }, inputData);
    };
    ClientInfoInputs.prototype.updateState = function (newState) {
        newState.dateOfBirth = new Date(newState.dob);
        this.setState(newState);
        this.props.handleClientInfoUpdate(newState);
    };
    //handleOnChange_Age(event: any) {
    //    console.log("QuoteInput-> handleOnChange_Age");
    //    const text = event.target.value.trim();
    //    console.log(text);
    //    let newState = assign({}, this.state, { age: text })
    //    this.setState(newState);
    //    //  this.props.submitQuote({});
    //}
    ClientInfoInputs.prototype.handleStateLocationChange = function (selectState) {
        console.log("ClientInfoInput->handleStateLocationChange:", selectState);
        if (this.state.state != selectState) {
            var newState = lodash_1.assign({}, this.state, { state: selectState });
            this.updateState(newState);
        }
    };
    ClientInfoInputs.prototype.handleInputChange = function (event) {
        ...
        if (target.htmlFor == 'gender' && target.firstChild) {
            ...
            if (this.state.gender != value) {
                var newState = lodash_1.assign({}, this.state, { gender: value == "M" ? "M" : "F" });
                this.updateState(newState);
            }
        }
        else {
    ...
    ClientInfoInputs.prototype.componentWillReceiveProps = function (nextProps) {
        console.log("clientInforInputs componentWillReceiveProps");
        this.initData(nextProps);
        // this.updateState(newState);
    };
    ClientInfoInputs.prototype.render = function () {
        console.log("clientInforInputs->render");
        return (React.createElement("div", { className: "form-group" },
            React.createElement("div", { className: "col col-xs-12" },
                React.createElement("h2", null, "Client Details")),
            React.createElement("div", { className: "col-xs-12" },
                React.createElement("div", { className: "col-xs-12" },
                    React.createElement("label", { htmlFor: "clientName", className: "control-label LifePipeLabel" }, " Client Name (Optional)")),
                React.createElement("div", { className: "col-sm-8 col-xs-12" },
                    React.createElement("input", { className: "form-control", name: "clientName", value: this.state.clientName, onChange: this.handleInputChange.bind(this) }))),
            React.createElement("div", { className: "col-xs-12" },
                React.createElement("div", { className: "col-sm-5 col-xs-7" },
                    React.createElement("label", { htmlFor: "dob", className: "control-label LifePipeLabel" }, " Date of Birth(Optional)")),
                React.createElement("div", { className: "col-sm-3 col-xs-4  col-xs-offset-1 " },
                    React.createElement("label", { htmlFor: "age", className: "control-label LifePipeLabel" }, " Age"))),
            React.createElement("div", { className: "col-xs-12" },
                React.createElement("div", { className: "col-sm-5 col-xs-7" },
                    React.createElement("input", { className: "form-control", name: "dob", placeholder: "YYYY-MM-DD", type: "text", value: this.state.dob, onChange: this.handleInputChange.bind(this) })),
                React.createElement("div", { className: "col-sm-3 col-xs-4  col-xs-offset-1 " },
                    React.createElement("div", { className: "input-group" },
                        React.createElement("input", { className: "form-control", name: "age", value: this.state.age, "aria-describedby": "basic-addon-age", onChange: this.handleInputChange.bind(this) }),
                        React.createElement("span", { className: "input-group-addon" }, "yrs")))),
            React.createElement("div", { className: "col-xs-12" },
                React.createElement("div", { className: "col-xs-12" },
                    React.createElement("label", { htmlFor: "genderGroup", className: "control-label LifePipeLabel" }, " Gender")),
                React.createElement("div", { className: " col-sm-6 col-xs-12" },
                    React.createElement("div", { className: "btn-group", "data-toggle": "buttons" },
                        React.createElement("label", { htmlFor: "gender", value: "M", className: "btn btn-primary " + (this.state.gender == "M" ? "active" : ""), onClick: this.handleInputChange.bind(this) },
                            React.createElement("input", { type: "radio", autoComplete: "off", name: "gender", id: "Gender-male", checked: this.state.gender == "M", value: "M", style: btWidth }),
                            " Male"),
                        React.createElement("label", { htmlFor: "gender", value: "F", className: "btn btn-primary " + (this.state.gender == "F" ? "active" : ""), onClick: this.handleInputChange.bind(this) },
                            React.createElement("input", { type: "radio", autoComplete: "off", name: "gender", id: "Gender-female", value: "F", style: btWidth, checked: this.state.gender == "F", onChange: this.handleInputChange.bind(this) }),
                            " Female")))),
            React.createElement("div", { className: "col-xs-12" },
                React.createElement("div", { className: "col-xs-12" },
                    React.createElement("label", { htmlFor: "State", className: "control-label LifePipeLabel" }, " State")),
                React.createElement("div", { className: " col-sm-5 col-xs-8" },
                    React.createElement(StatesPicker_1.StatesPicker, { selectedValue: this.state.state, handleStateLocationChange: this.handleStateLocationChange.bind(this) })))));
    };
    return ClientInfoInputs;
}(React.Component));
exports.ClientInfoInputs = ClientInfoInputs;
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var FilterMain_1 = __webpack_require__(19);
                ...
                React.createElement("div", { className: "modal-dialog" },
                    React.createElement("div", { className: "modal-content" },
                        ...
                        React.createElement("div", { className: "modal-body" },
                            React.createElement(FilterMain_1.FilterMain, { filter: this.props.filter, handleFilterUpdate: this.props.handleFilterUpdate })),
    ...
    Footer.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement("footer", null,
                React.createElement("p", { className: "pull-right" }, "\u00A92017 content R&D - iPipeLine"))));
    };
    return Footer;
}(React.Component));
...
var Header = (function (_super) {
    ...
    Header.prototype.render = function () {
        console.log("Header->props.page:", this.props.Page);
        return (React.createElement("div", null,
            React.createElement("nav", { className: "navbar navbar-inverse navbar-fixed-top ipipeline-navbar-top" },
                React.createElement("div", { className: "container" },
                    React.createElement("div", { className: "navbar-header" },
                        ...
                        React.createElement("a", { className: "navbar-brand", href: "#" },
                            React.createElement("img", { className: "ipipeline-logo img-responsive  ", src: "dist/Images/ipipelineLogo.png" }))),
                    React.createElement("div", { id: "navbar", className: "collapse navbar-collapse" },
                        React.createElement("ul", { className: "nav navbar-nav navbar-right" },
                            React.createElement("li", { className: "active", style: this.props.Page == state_1.EnumPage.Results ? { display: "block" } : { display: "none" } },
                                React.createElement("a", { href: "index.html" }, "New Quote")),
                            ...
                            React.createElement("li", { role: "presentation", className: "dropdown" },
                                ...
                                React.createElement("ul", { className: "dropdown-menu" },
                                    React.createElement("li", null,
                                        React.createElement("a", { href: "#" }, "My Cart")),
                                    React.createElement("li", { role: "separator", className: "divider" }),
                                    React.createElement("li", null,
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { className: "col-xs-12" },
                React.createElement("div", { className: "col-xs-12" },
                    React.createElement("label", { className: "control-label LifePipeLabel" }, " Term Length(s) ")),
                React.createElement("div", { className: "col-sm-7 col-xs-8" },
                    React.createElement("div", { className: "btn-toolbar", role: "toolbar", "aria-label": "..." }, this.state.avaliableTerms.map(function (item) {
                        return (React.createElement("div", { className: "btn-group", key: "input-term-" + item.value },
                            React.createElement("button", { type: "button", name: "input-term-" + item.value, value: item.value, onClick: _this.handleInputChange.bind(_this), className: "btn btn-primary " + ((_this.state.terms.indexOf(item.value) > -1) ? 'active' : '') }, item.label)));
                    }))))));
    };
...
var React = __webpack_require__(0);
;
var iconStyle = { color: "dodgerblue", fontSize: "1.4em" };
var QuoteInfoDisplay = (function (_super) {
    __extends(QuoteInfoDisplay, _super);
    function QuoteInfoDisplay() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ...
    return QuoteInfoDisplay;
}(React.Component));
exports.QuoteInfoDisplay = QuoteInfoDisplay;
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var QuoteResultsProductRow_1 = __webpack_require__(50);
;
var QuoteResultsPanel = (function (_super) {
    __extends(QuoteResultsPanel, _super);
    function QuoteResultsPanel() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
        ...
        return (React.createElement("div", { className: "panel panel-default" },
            ...
            React.createElement("div", { id: "collapse-" + groupKey, className: "panel-collapse collapse in" }, groupDataItems.map(function (dataItem) {
                if (_this.props.filter.paymentOptions.indexOf(dataItem.input.paymentOption) > -1) {
                    return React.createElement(QuoteResultsProductRow_1.QuoteResultsProductRow, { filter: _this.props.filter, dataItem: dataItem, key: dataItem.input.faceAmount + "-" + dataItem.input.paymentOption + "-" + dataItem.recId });
                }
            }))));
    };
    return QuoteResultsPanel;
}(React.Component));
exports.QuoteResultsPanel = QuoteResultsPanel;
...
var QuoteResultsProductRow = (function (_super) {
    __extends(QuoteResultsProductRow, _super);
    ...
    QuoteResultsProductRow.prototype.render = function () {
        ...
        if (dataItem.error) {
            return (React.createElement("div", { className: this.props.filter.showError ? "" : "hidden" },
                React.createElement("div", { className: "panel-footer" },
                    " companyId: ",
                    dataItem.input.companyId,
                    " productId: ",
                    dataItem.input.productId),
                React.createElement("div", { className: "panel-body" },
                    "Error: ",
                    React.createElement("span", { className: "alert-danger" },
                        " ",
                        dataItem.error,
                        " "))));
        }
        return (React.createElement("div", null,
            React.createElement("div", { className: "panel-footer" },
                dataItem.productVersionInfo.name,
                "  -  ",
                PaymentOptions_1.PaymentOptions[dataItem.input.paymentOption]),
            React.createElement("div", { className: "panel-body" },
                React.createElement("div", { className: "col-xs-6" },
                    React.createElement("img", { src: carrierLogo }),
                    React.createElement("div", null, " AM Best A+"),
                    React.createElement("div", null,
                        " ",
                        dataItem.productVersionInfo.healthNameLong)),
                React.createElement("div", { className: "col-xs-6" },
                    React.createElement("div", { className: "col-xs-12 noPading-right" },
                        React.createElement("div", { className: "pull-right" },
                            React.createElement("span", { style: priceTextStyle },
                                "$",
                                dataItem.totalPremium),
                            " /",
                            PaymentOptions_1.paymentOptionDisplays[dataItem.input.paymentOption])),
                    React.createElement("div", { className: "col-xs-12 noPading-right " },
                        React.createElement("div", { className: "dropdown pull-right" },
                            React.createElement("button", { className: "btn btn-success dropdown-toggle", type: "button", id: "dropdownMenu1", "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "true" },
                                "Apply",
                                React.createElement("span", { className: "caret" })),
...
exports.QuoteResultsProductRow = QuoteResultsProductRow;
...
//can move to stype
var btWidth = { width: "120px" };
var UnderwritingInputs = (function (_super) {
    __extends(UnderwritingInputs, _super);
    function UnderwritingInputs() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    UnderwritingInputs.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement("div", { className: "col col-xs-12" },
                React.createElement("h2", null, "Underwriting")),
            React.createElement("div", { className: "col-xs-12" },
                React.createElement("div", { className: " col-sm-10 col-xs-12" },
                    React.createElement("div", { className: "btn-group", "data-toggle": "buttons" },
                        React.createElement("label", { className: "btn btn-primary active", style: btWidth },
                            React.createElement("input", { type: "radio", autoComplete: "off", name: "Health", id: "HealthClass", checked: true }),
                            " Health Class"),
                        React.createElement("label", { className: "btn btn-primary", style: btWidth },
                            React.createElement("input", { type: "radio", autoComplete: "off", name: "Health", id: "HealthProfile" }),
                            " Health Profile")))),
            React.createElement("div", { className: "col-xs-12" },
                React.createElement("div", { className: "col-xs-12" },
                    React.createElement("label", { htmlFor: "Tobacco", className: "control-label LifePipeLabel" }, " Ever use nicotine or tobacco?")),
                React.createElement("div", { className: " col-sm-6 col-xs-8" },
                    React.createElement("select", { className: "form-control", id: "Tobacco", name: "Tobacco" },
                        React.createElement("option", { value: "" }, "Never "),
                        React.createElement("option", { value: "" }, "Currently "),
                        React.createElement("option", { value: "" }, "Less than 1yr ago "),
                        React.createElement("option", { value: "" }, "Quit 1-2yr ago ")))),
            React.createElement("div", { className: "col-xs-12" },
                React.createElement("div", { className: "col-sm-6 col-xs-6" },
                    React.createElement("label", { htmlFor: "Height", className: "control-label LifePipeLabel" }, " Height")),
                React.createElement("div", { className: "col-sm-3 col-xs-4  col-xs-offset-1 " },
                    React.createElement("label", { htmlFor: "Weight", className: "control-label LifePipeLabel" }, " Weight"))),
            React.createElement("div", { className: "col-xs-12" },
                React.createElement("div", { className: "col-sm-3 col-xs-3 " },
                    React.createElement("div", { className: "input-group" },
                        React.createElement("input", { className: "form-control", id: "Hight-ft", name: "Hight-ft", "aria-describedby": "basic-addon-hight-ft" }),
                        React.createElement("span", { className: "input-group-addon", id: "basic-addon-hight-ft" }, "ft"))),
                React.createElement("div", { className: "col-sm-3 col-xs-3" },
                    React.createElement("div", { className: "input-group" },
                        React.createElement("input", { className: "form-control", id: "Hight-in", name: "Hight-in", "aria-describedby": "basic-addon-hight-in" }),
                        React.createElement("span", { className: "input-group-addon", id: "basic-addon-hight-in" }, "in"))),
                React.createElement("div", { className: "col-sm-3 col-xs-4 col-xs-offset-1  " },
                    React.createElement("div", { className: "input-group" },
                        React.createElement("input", { className: "form-control", id: "Weight", name: "Weight", value: "", "aria-describedby": "basic-addon-weight" }),
                        React.createElement("span", { className: "input-group-addon", id: "basic-addon-weight" }, "lbs"))))));
    };
    return UnderwritingInputs;
}(React.Component));
exports.UnderwritingInputs = UnderwritingInputs;
...
var QuoteInput = (function (_super) {
    ...
    function QuoteInput(props) {
        var _this = this;
        console.log("QuoteInput->constructor");
        _this = _super.call(this, props) || this;
        _this.state = props.state.quoteInputData;
        return _this;
    }
    QuoteInput.prototype.handleContinueClick = function (event) {
        console.log("QuoteInput->handleContinueClick");
    ...
    QuoteInput.prototype.componentWillReceiveProps = function (nextProps) {
        console.log("QuoteInput->componentWillReceiveProps", nextProps);
        // let newState: IQuoteInputData = assign({}, this.state, nextProps.state.quoteInputData);
        this.state = nextProps.state.quoteInputData;
        //  this.setState(newState);   
    };
    QuoteInput.prototype.render = function () {
        // let data = this.props.state; //todo: get input data from state passed from top
        console.log("QuoteInput->render");
        if (this.props.state.currentpage === state_1.EnumPage.QuoteInputAndSubmit) {
            this.handleContinueClick(null);
            ;
            return (React.createElement("div", null));
        }
        else {
                        ...
                        React.createElement("form", null,
                            ...
                            React.createElement("div", { className: "col container-fluid" },
                                React.createElement("div", { className: " col-xs-5" },
                                    React.createElement("button", { type: "button", className: "btn btn-lg btn-default btn-block", title: "reset" }, "Reset")),
                                React.createElement("div", { className: " col-xs-7" },
                                    React.createElement("button", { type: "button", className: "btn btn-lg btn-info btn-block", title: "quote", id: "btnGetResult", onClick: this.handleContinueClick.bind(this) }, "Continue to Results"))),
                            React.createElement("div", { className: "col col-xs-12" }))))));
        }
    };
    return QuoteInput;
...
var React = __webpack_require__(0);
;
var QuoteLoading = (function (_super) {
    __extends(QuoteLoading, _super);
    function QuoteLoading() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    QuoteLoading.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement("div", { className: "container" },
                React.createElement("div", { className: "col-sm-offset-2" },
                    React.createElement("div", { className: "container" },
                        React.createElement("div", { className: "col-sm-offset-2" },
                            React.createElement("img", { src: "dist/Images/loader.gif" }),
                            "loading...."))))));
    };
    return QuoteLoading;
}(React.Component));
exports.QuoteLoading = QuoteLoading;
            ...
            React.createElement("div", { className: "container-fluid" },
                ...
                React.createElement("div", { className: "col-sm-8  col-md-9  main" },
                    ...
                    React.createElement("div", { className: "col-xs-12", style: iconBarPadding },
                        ...
                        React.createElement("div", { className: "col-xs-12 noPading-right" },
                            React.createElement("div", { className: "row col-xs-3" },
                                React.createElement("button", { type: "button", className: "btn btn-default  hidden-sm hidden-md hidden-lg hidden-print ", "data-toggle": "modal", "data-target": "#modal-fullscreen" },
                                    React.createElement("span", { className: "glyphicon glyphicon-filter" }),
                                    " Filter")),
                            React.createElement("div", { className: "col-xs-6 text-center" }, " 9 results "),
                            React.createElement("div", { className: "col-xs-3 noPading-right" },
                                React.createElement("button", { type: "button", className: "btn btn-default btn-sm pull-right" },
                    ...
                    React.createElement("div", { className: "col-xs-12 panel-group" }, groupResultsKeys.map(function (groupKey) {
                        ...
                        if (_this.state.selectedTerms.indexOf(dataItems.groupTerm) > -1) {
                            return React.createElement(_1.QuoteResultsPanel, { groupDataItems: dataItems, filter: _this.state, key: groupKey });
                        }
                    }))),
...
exports.QuoteResults = QuoteResults;
    ...
    "result": [
        {
            ...
            "error": "{\"message\":\"quoteAmount : basePremium : baseRate : faceAmount is out of the defined bands\"}"
        },
        {
            "input": {
                "isGuaranteed": true,
        ...
        },
        {
            ...
            "productVersionInfo": {
                "isGuaranteed": true,
                "showYtdRates": false,
                "healthNameLong": "Preferred Plus Non-Tobacco",
                "forTestingOnly": false,
                "simplifiedIssue": false,
                "expirationDate": "2099-12-31",
                "updatedDate": "02 May 2016",
                "useAgeNearest": true,
                "solveFaceAmount": false,
                "states": "AL;AK;AZ;AR;CA;CO;CT;DE;DC;FL;GA;HI;ID;IL;IN;IA;KS;KY;LA;ME;MD;MA;MI;MN;MS;MO;MT;NE;NV;NH;NJ;NM;NC;ND;OH;OK;OR;PA;RI;SC;SD;TN;TX;UT;VT;VA;WA;WV;WI;WY",
                "roundingPosition": 5,
                "activationDate": "2017-01-01",
                "id": "581b4c515c95926ba1f8dc5d",
                "updatedAt": "2017-01-10T14:48:16.274Z",
                "createdAt": "2016-11-03T14:40:17.000Z",
                "isProductType": false,
                "name": "testResolveFaceAmt-fromNewProdVesion",
                "resolveFaceAmount": false,
                "active": true,
                "disclosure": "<div>OPTerm policy form # ICC12OPTN and state variations. Not available in all states.   Policy descriptions provided here are not a statement of contract and are not for public distribution.</div><div><br></div><div>OPTerm 10 issue ages 20-75 all classes, </div><div>OPTerm 15 issue ages 20-75 all classes, </div><div>OPTerm 20 issue ages 20-70 non-tobacco classes, 20-65 tobacco classes, </div><div>OPTerm 25 issue ages 20-60 non-tobacco classes, 20-55 tobacco classes, </div><div>OPTerm 30 issue ages 20-55 non-tobacco classes, 20-50 tobacco classes, </div><div><br></div><div>Premium rates vary by coverage amount:</div><ul><li>   $100,000-$249,999; </li><li>   $250,000-$499,999; </li><li>   $500,000-$999,999;   </li><li>   $1,000,000 and above</li></ul><div><br></div><div>Premiums quoted include $60 annual policy fee.</div><div><br></div><div>Premiums are guaranteed to stay level for 10, 15, 20, 25 or 30 years, respectively, and increase annually after initial guarantee period.</div><div><br></div><div>OPTerm policies can be issued in preferred plus non-tobacco, preferred non-tobacco, standard plus non-tobacco, standard non-tobacco,   preferred tobacco and standard tobacco classes.</div><div><br></div><div> OPTerm 10, 15, 20, 25 and 30 substandard policies can be issued through Table 12, subject to underwriting discretion.</div><div><br></div><div> Coverage can be renewed to age 95.</div><div><br></div><div> Rates effective 05/05/2016.</div>",
                "notes": "<div>Rates effective 12/31/2016</div> for Test Resolve FaceAmt feature",
                "vid": "100",
                "simplified": false,
                "healthNameShort": "PPNT",
                "ageApproxType": "nearest"
            },
            "wp": 0,
            "recId": "1001001003",
            "messages": [],
...
var mockQuoteReceivedDatas = mockResultJSON;
exports.mockQuoteReceivedDatas = mockQuoteReceivedDatas;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mapDispatchToProps__ = __webpack_require__(90);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(94);
